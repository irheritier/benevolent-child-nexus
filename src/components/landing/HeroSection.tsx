...
export const HeroSection = ({ title, subtitle, heroDescription, registerText, exploreMapText }: HeroSectionProps) => {
  return (
    <section className="relative h-[calc(100vh-100px)] sm:h-[calc(100vh-90px)] md:h-[calc(100vh-85px)] lg:h-[calc(100vh-80px)] flex items-center px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950 dark:via-slate-900 dark:to-purple-950">
