...
import { Heart, LogIn, AlertCircle, Shield, ArrowLeft, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      className="h-12 border-slate-200 dark:border-slate-600 focus:border-blue-500 dark:focus:border-blue-400 bg-white dark:bg-slate-700 pr-12"
                      disabled={isLoading}
                    />
                    <Button
                      type="button"
